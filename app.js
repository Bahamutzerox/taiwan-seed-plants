...
// ── APG V 科別分組對照表（順序依 Byng et al. 2026 Linear Classification）─
const APG_FAMILY = {
  // 裸子植物
  ...
  // 被子植物基群 + 木蘭類（含金魚藻）
  'Cabombaceae':     { group: 1, ord: '睡蓮目',   order:   3 },
  'Nymphaeaceae':    { group: 1, ord: '睡蓮目',   order:   4 },
  'Schisandraceae':  { group: 1, ord: '八角目',   order:   7 },
  'Chloranthaceae':  { group: 1, ord: '金粟蘭目', order:   8 },
  'Aristolochiaceae':{ group: 1, ord: '胡椒目',   order:  11 },
  'Saururaceae':     { group: 1, ord: '胡椒目',   order:  12 },
  'Piperaceae':      { group: 1, ord: '胡椒目',   order:  13 },
  'Myristicaceae':   { group: 1, ord: '木蘭目',   order:  14 },
  'Magnoliaceae':    { group: 1, ord: '木蘭目',   order:  17 },
  'Annonaceae':      { group: 1, ord: '木蘭目',   order:  19 },
  'Hernandiaceae':   { group: 1, ord: '樟目',     order:  23 },
  'Lauraceae':       { group: 1, ord: '樟目',     order:  26 },
  'Ceratophyllaceae':{ group: 1, ord: '金魚藻目', order: 103 },

  // 單子葉植物
  'Acoraceae':       { group: 2, ord: '菖蒲目',   order:  27 },
  'Araceae':         { group: 2, ord: '澤瀉目',   order:  29 },
  'Alismataceae':    { group: 2, ord: '澤瀉目',   order:  30 },
  'Hydrocharitaceae':{ group: 2, ord: '澤瀉目',   order:  32 },
  'Aponogetonaceae': { group: 2, ord: '澤瀉目',   order:  33 },
  'Ruppiaceae':      { group: 2, ord: '澤瀉目',   order:  38 },
  'Cymodoceaceae':   { group: 2, ord: '澤瀉目',   order:  39 },
  'Zosteraceae':     { group: 2, ord: '澤瀉目',   order:  40 },
  'Potamogetonaceae':{ group: 2, ord: '澤瀉目',   order:  41 },
  'Petrosaviaceae':  { group: 2, ord: '櫻井草目', order:  42 },
  'Nartheciaceae':   { group: 2, ord: '薯蕷目',   order:  43 },
  'Burmanniaceae':   { group: 2, ord: '薯蕷目',   order:  44 },
  'Dioscoreaceae':   { group: 2, ord: '薯蕷目',   order:  45 },
  'Triuridaceae':    { group: 2, ord: '露兜樹目', order:  47 },
  'Stemonaceae':     { group: 2, ord: '露兜樹目', order:  48 },
  'Pandanaceae':     { group: 2, ord: '露兜樹目', order:  50 },
  'Melanthiaceae':   { group: 2, ord: '百合目',   order:  53 },
  'Colchicaceae':    { group: 2, ord: '百合目',   order:  56 },
  'Smilacaceae':     { group: 2, ord: '百合目',   order:  59 },
  'Liliaceae':       { group: 2, ord: '百合目',   order:  60 },
  'Orchidaceae':     { group: 2, ord: '天門冬目', order:  61 },
  'Hypoxidaceae':    { group: 2, ord: '天門冬目', order:  66 },
  'Iridaceae':       { group: 2, ord: '天門冬目', order:  69 },
  'Asphodelaceae':   { group: 2, ord: '天門冬目', order:  71 },
  'Amaryllidaceae':  { group: 2, ord: '天門冬目', order:  72 },
  'Asparagaceae':    { group: 2, ord: '天門冬目', order:  73 },
  'Arecaceae':       { group: 2, ord: '棕櫚目',   order:  75 },
  'Pontederiaceae':  { group: 2, ord: '鴨跖草目', order:  76 },
  'Philydraceae':    { group: 2, ord: '鴨跖草目', order:  78 },
  'Commelinaceae':   { group: 2, ord: '鴨跖草目', order:  80 },
  'Musaceae':        { group: 2, ord: '薑目',     order:  81 },
  'Cannaceae':       { group: 2, ord: '薑目',     order:  85 },
  'Marantaceae':     { group: 2, ord: '薑目',     order:  86 },
  'Costaceae':       { group: 2, ord: '薑目',     order:  87 },
  'Zingiberaceae':   { group: 2, ord: '薑目',     order:  88 },
  'Typhaceae':       { group: 2, ord: '禾本目',   order:  89 },
  'Juncaceae':       { group: 2, ord: '禾本目',   order:  93 },
  'Eriocaulaceae':   { group: 2, ord: '禾本目',   order:  95 },
  'Xyridaceae':      { group: 2, ord: '禾本目',   order:  96 },
  'Flagellariaceae': { group: 2, ord: '禾本目',   order:  98 },
  'Cyperaceae':      { group: 2, ord: '禾本目',   order: 100 },
  'Poaceae':         { group: 2, ord: '禾本目',   order: 101 },

  // 真雙子葉植物
  // Ranunculales 毛茛目
  'Papaveraceae':    { group: 3, ord: '毛茛目',    order: 105 },
  'Lardizabalaceae': { group: 3, ord: '毛茛目',    order: 107 },
  'Menispermaceae':  { group: 3, ord: '毛茛目',    order: 108 },
  'Berberidaceae':   { group: 3, ord: '毛茛目',    order: 109 },
  'Ranunculaceae':   { group: 3, ord: '毛茛目',    order: 110 },
  // Proteales 山龍眼目
  'Sabiaceae':       { group: 3, ord: '山龍眼目',  order: 111 },
  'Proteaceae':      { group: 3, ord: '山龍眼目',  order: 114 },
  // Trochodendrales 昆欄樹目
  'Trochodendraceae':{ group: 3, ord: '昆欄樹目',  order: 115 },
  // Buxales 黃楊目
  'Buxaceae':        { group: 3, ord: '黃楊目',    order: 116 },
  // Vitales 葡萄目
  'Vitaceae':        { group: 3, ord: '葡萄目',    order: 120 },
  // Saxifragales 虎耳草目（含 Daphniphyllaceae，APG V 移入本目）
  'Daphniphyllaceae':{ group: 3, ord: '虎耳草目',  order: 124 },
  'Altingiaceae':    { group: 3, ord: '虎耳草目',  order: 126 },
  'Hamamelidaceae':  { group: 3, ord: '虎耳草目',  order: 127 },
  'Iteaceae':        { group: 3, ord: '虎耳草目',  order: 128 },
  'Grossulariaceae': { group: 3, ord: '虎耳草目',  order: 129 },
  'Saxifragaceae':   { group: 3, ord: '虎耳草目',  order: 130 },
  'Haloragaceae':    { group: 3, ord: '虎耳草目',  order: 134 },
  'Crassulaceae':    { group: 3, ord: '虎耳草目',  order: 135 },
  // Crossosomatales 旌節花目
  'Stachyuraceae':   { group: 3, ord: '旌節花目',  order: 140 },
  'Staphyleaceae':   { group: 3, ord: '旌節花目',  order: 142 },
  // Geraniales 牻牛兒苗目
  'Geraniaceae':     { group: 3, ord: '牻牛兒苗目',order: 144 },
  // Zygophyllales 蒺藜目
  'Zygophyllaceae':  { group: 3, ord: '蒺藜目',    order: 146 },
  // Myrtales 桃金孃目
  'Combretaceae':    { group: 3, ord: '桃金孃目',  order: 147 },
  'Lythraceae':      { group: 3, ord: '桃金孃目',  order: 148 },
  'Onagraceae':      { group: 3, ord: '桃金孃目',  order: 149 },
  'Melastomataceae': { group: 3, ord: '桃金孃目',  order: 153 },
  'Myrtaceae':       { group: 3, ord: '桃金孃目',  order: 155 },
  // Fagales 殼斗目
  'Myricaceae':      { group: 3, ord: '殼斗目',    order: 157 },
  'Juglandaceae':    { group: 3, ord: '殼斗目',    order: 158 },
  'Casuarinaceae':   { group: 3, ord: '殼斗目',    order: 159 },
  'Betulaceae':      { group: 3, ord: '殼斗目',    order: 161 },
  'Fagaceae':        { group: 3, ord: '殼斗目',    order: 162 },
  // Fabales 豆目
  'Surianaceae':     { group: 3, ord: '豆目',      order: 163 },
  'Polygalaceae':    { group: 3, ord: '豆目',      order: 164 },
  'Fabaceae':        { group: 3, ord: '豆目',      order: 166 },
  // Cucurbitales 葫蘆目
  'Coriariaceae':    { group: 3, ord: '葫蘆目',    order: 169 },
  'Cucurbitaceae':   { group: 3, ord: '葫蘆目',    order: 170 },
  'Begoniaceae':     { group: 3, ord: '葫蘆目',    order: 173 },
  // Rosales 薔薇目
  'Elaeagnaceae':    { group: 3, ord: '薔薇目',    order: 176 },
  'Rhamnaceae':      { group: 3, ord: '薔薇目',    order: 177 },
  'Ulmaceae':        { group: 3, ord: '薔薇目',    order: 178 },
  'Cannabaceae':     { group: 3, ord: '薔薇目',    order: 179 },
  'Moraceae':        { group: 3, ord: '薔薇目',    order: 180 },
  'Urticaceae':      { group: 3, ord: '薔薇目',    order: 181 },
  'Rosaceae':        { group: 3, ord: '薔薇目',    order: 182 },
  // Celastrales 衛矛目
  'Celastraceae':    { group: 3, ord: '衛矛目',    order: 185 },
  // Malpighiales 金虎尾目
  'Clusiaceae':      { group: 3, ord: '金虎尾目',  order: 194 },
  'Calophyllaceae':  { group: 3, ord: '金虎尾目',  order: 195 },
  'Hypericaceae':    { group: 3, ord: '金虎尾目',  order: 197 },
  'Putranjivaceae':  { group: 3, ord: '金虎尾目',  order: 200 },
  'Elatinaceae':     { group: 3, ord: '金虎尾目',  order: 202 },
  'Malpighiaceae':   { group: 3, ord: '金虎尾目',  order: 203 },
  'Linaceae':        { group: 3, ord: '金虎尾目',  order: 204 },
  'Rhizophoraceae':  { group: 3, ord: '金虎尾目',  order: 206 },
  'Passifloraceae':  { group: 3, ord: '金虎尾目',  order: 217 },
  'Salicaceae':      { group: 3, ord: '金虎尾目',  order: 216 },
  'Violaceae':       { group: 3, ord: '金虎尾目',  order: 218 },
  'Phyllanthaceae':  { group: 3, ord: '金虎尾目',  order: 220 },
  'Euphorbiaceae':   { group: 3, ord: '金虎尾目',  order: 221 },
  // Huerteales 十齒花目
  'Dipentodontaceae':{ group: 3, ord: '十齒花目',  order: 225 },
  // Oxalidales 酢醬草目
  'Connaraceae':     { group: 3, ord: '酢醬草目',  order: 226 },
  'Oxalidaceae':     { group: 3, ord: '酢醬草目',  order: 227 },
  'Elaeocarpaceae':  { group: 3, ord: '酢醬草目',  order: 231 },
  // Sapindales 無患子目
  'Sapindaceae':     { group: 3, ord: '無患子目',  order: 234 },
  'Anacardiaceae':   { group: 3, ord: '無患子目',  order: 237 },
  'Simaroubaceae':   { group: 3, ord: '無患子目',  order: 238 },
  'Rutaceae':        { group: 3, ord: '無患子目',  order: 239 },
  'Meliaceae':       { group: 3, ord: '無患子目',  order: 240 },
  // Brassicales 十字花目
  'Caricaceae':      { group: 3, ord: '十字花目',  order: 242 },
  'Akaniaceae':      { group: 3, ord: '十字花目',  order: 243 },
  'Capparaceae':     { group: 3, ord: '十字花目',  order: 255 },
  'Cleomaceae':      { group: 3, ord: '十字花目',  order: 256 },
  'Brassicaceae':    { group: 3, ord: '十字花目',  order: 257 },
  // Malvales 錦葵目
  'Thymelaeaceae':   { group: 3, ord: '錦葵目',    order: 260 },
  'Muntingiaceae':   { group: 3, ord: '錦葵目',    order: 261 },
  'Malvaceae':       { group: 3, ord: '錦葵目',    order: 267 },
  // Santalales 檀香目
  'Olacaceae':       { group: 3, ord: '檀香目',    order: 270 },
  'Opiliaceae':      { group: 3, ord: '檀香目',    order: 271 },
  'Balanophoraceae': { group: 3, ord: '檀香目',    order: 272 },
  'Santalaceae':     { group: 3, ord: '檀香目',    order: 273 },
  'Schoepfiaceae':   { group: 3, ord: '檀香目',    order: 275 },
  'Loranthaceae':    { group: 3, ord: '檀香目',    order: 276 },
  // Caryophyllales 石竹目
  'Droseraceae':     { group: 3, ord: '石竹目',    order: 277 },
  'Frankeniaceae':   { group: 3, ord: '石竹目',    order: 282 },
  'Plumbaginaceae':  { group: 3, ord: '石竹目',    order: 283 },
  'Polygonaceae':    { group: 3, ord: '石竹目',    order: 284 },
  'Amaranthaceae':   { group: 3, ord: '石竹目',    order: 292 },
  'Caryophyllaceae': { group: 3, ord: '石竹目',    order: 293 },
  'Aizoaceae':       { group: 3, ord: '石竹目',    order: 299 },
  'Phytolaccaceae':  { group: 3, ord: '石竹目',    order: 301 },
  'Petiveriaceae':   { group: 3, ord: '石竹目',    order: 302 },
  'Nyctaginaceae':   { group: 3, ord: '石竹目',    order: 303 },
  'Molluginaceae':   { group: 3, ord: '石竹目',    order: 304 },
  'Basellaceae':     { group: 3, ord: '石竹目',    order: 307 },
  'Talinaceae':      { group: 3, ord: '石竹目',    order: 309 },
  'Portulacaceae':   { group: 3, ord: '石竹目',    order: 311 },
  'Cactaceae':       { group: 3, ord: '石竹目',    order: 312 },
  // Cornales 山茱萸目
  'Cornaceae':       { group: 3, ord: '山茱萸目',  order: 319 },
  'Hydrangeaceae':   { group: 3, ord: '山茱萸目',  order: 320 },
  // Ericales 杜鵑花目
  'Mitrastemonaceae':{ group: 3, ord: '杜鵑花目',  order: 322 },
  'Balsaminaceae':   { group: 3, ord: '杜鵑花目',  order: 325 },
  'Lecythidaceae':   { group: 3, ord: '杜鵑花目',  order: 326 },
  'Ebenaceae':       { group: 3, ord: '杜鵑花目',  order: 329 },
  'Primulaceae':     { group: 3, ord: '杜鵑花目',  order: 330 },
  'Pentaphylacaceae':{ group: 3, ord: '杜鵑花目',  order: 331 },
  'Sapotaceae':      { group: 3, ord: '杜鵑花目',  order: 332 },
  'Theaceae':        { group: 3, ord: '杜鵑花目',  order: 333 },
  'Symplocaceae':    { group: 3, ord: '杜鵑花目',  order: 334 },
  'Styracaceae':     { group: 3, ord: '杜鵑花目',  order: 335 },
  'Diapensiaceae':   { group: 3, ord: '杜鵑花目',  order: 336 },
  'Actinidiaceae':   { group: 3, ord: '杜鵑花目',  order: 338 },
  'Ericaceae':       { group: 3, ord: '杜鵑花目',  order: 341 },
  // Cardiopteridales 心翼果目
  'Stemonuraceae':   { group: 3, ord: '心翼果目',  order: 344 },
  // Garryales 絞木目
  'Garryaceae':      { group: 3, ord: '絞木目',    order: 346 },
  // Aquifoliales 冬青目
  'Helwingiaceae':   { group: 3, ord: '冬青目',    order: 347 },
  'Aquifoliaceae':   { group: 3, ord: '冬青目',    order: 348 },
  // Solanales 茄目
  'Sphenocleaceae':  { group: 3, ord: '茄目',      order: 352 },
  'Hydroleaceae':    { group: 3, ord: '茄目',      order: 353 },
  'Convolvulaceae':  { group: 3, ord: '茄目',      order: 354 },
  'Solanaceae':      { group: 3, ord: '茄目',      order: 355 },
  // Boraginales 紫草目
  'Boraginaceae':    { group: 3, ord: '紫草目',    order: 356 },
  'Coldeniaceae':    { group: 3, ord: '紫草目',    order: 356 },
  'Cordiaceae':      { group: 3, ord: '紫草目',    order: 356 },
  'Ehretiaceae':     { group: 3, ord: '紫草目',    order: 356 },
  'Heliotropiaceae': { group: 3, ord: '紫草目',    order: 356 },
  // Gentianales 龍膽目
  'Gentianaceae':    { group: 3, ord: '龍膽目',    order: 358 },
  'Loganiaceae':     { group: 3, ord: '龍膽目',    order: 359 },
  'Apocynaceae':     { group: 3, ord: '龍膽目',    order: 360 },
  'Rubiaceae':       { group: 3, ord: '龍膽目',    order: 361 },
  // Lamiales 唇形目
  'Carlemanniaceae': { group: 3, ord: '唇形目',    order: 363 },
  'Oleaceae':        { group: 3, ord: '唇形目',    order: 364 },
  'Gesneriaceae':    { group: 3, ord: '唇形目',    order: 366 },
  'Plantaginaceae':  { group: 3, ord: '唇形目',    order: 367 },
  'Linderniaceae':   { group: 3, ord: '唇形目',    order: 369 },
  'Scrophulariaceae':{ group: 3, ord: '唇形目',    order: 370 },
  'Lentibulariaceae':{ group: 3, ord: '唇形目',    order: 372 },
  'Pedaliaceae':     { group: 3, ord: '唇形目',    order: 374 },
  'Acanthaceae':     { group: 3, ord: '唇形目',    order: 375 },
  'Verbenaceae':     { group: 3, ord: '唇形目',    order: 377 },
  'Bignoniaceae':    { group: 3, ord: '唇形目',    order: 379 },
  'Orobanchaceae':   { group: 3, ord: '唇形目',    order: 380 },
  'Lamiaceae':       { group: 3, ord: '唇形目',    order: 381 },
  // Asterales 菊目
  'Campanulaceae':   { group: 3, ord: '菊目',      order: 387 },
  'Stylidiaceae':    { group: 3, ord: '菊目',      order: 388 },
  'Menyanthaceae':   { group: 3, ord: '菊目',      order: 392 },
  'Goodeniaceae':    { group: 3, ord: '菊目',      order: 393 },
  'Asteraceae':      { group: 3, ord: '菊目',      order: 395 },
  // Dipsacales 川續斷目
  'Adoxaceae':       { group: 3, ord: '川續斷目',  order: 399 },
  'Caprifoliaceae':  { group: 3, ord: '川續斷目',  order: 400 },
  // Apiales 繖形目
  'Pittosporaceae':  { group: 3, ord: '繖形目',    order: 404 },
  'Araliaceae':      { group: 3, ord: '繖形目',    order: 405 },
  'Apiaceae':        { group: 3, ord: '繖形目',    order: 407 },
};
...
const APG_ORDER_LAT = {
  ...
  '菖蒲目': 'Acorales', '澤瀉目': 'Alismatales', '櫻井草目': 'Petrosaviales',
  ...
  '山茱萸目': 'Cornales', '杜鵑花目': 'Ericales',
  '心翼果目': 'Cardiopteridales', '絞木目': 'Garryales', '冬青目': 'Aquifoliales',
  '茄目': 'Solanales', '紫草目': 'Boraginales', '龍膽目': 'Gentianales',
  '唇形目': 'Lamiales', '菊目': 'Asterales', '川續斷目': 'Dipsacales', '繖形目': 'Apiales',
};
...
<div class="td-genus">
  ...
  <ol class="td-sp-list">${genusSp}</ol>
      ...
      if (familyVisible) {
        ...
        const famRefsTog = family.refs.length > 0
